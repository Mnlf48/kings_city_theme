...
?>
<article class="card-glass" onclick="window.location.href='<?php echo $_post_url_js; ?>'" style="cursor: pointer; border-radius: 0;">
	<?php if ( $_image_id ) : ?>
	...
	<div style="padding: var(--space-lg);">
		...
		<p style="color: var(--color-text-muted); font-size: 0.9rem; line-height: 1.6; margin-bottom: 1.5rem;"><?php echo esc_html( $_excerpt ); ?></p>
		<div style="display: flex; justify-content: space-between; align-items: center;">
			<span style="font-size: 0.75rem; color: var(--color-text-muted);"><?php echo esc_html( get_the_date( 'F j, Y' ) ); ?></span>
			<a class="btn btn--small" href="<?php echo $_post_url; ?>" style="padding: 0.5rem 1rem; font-size: 0.8rem;">Read More</a>
		</div>
	</div>
</article>
