...
SET SOURCE_DIR=C:\xampp\htdocs\kings-city-theme\the-kings-city-club
...
robocopy "C:\xampp\htdocs\kings-city-theme\the-kings-city-club" "C:\xampp\htdocs\the-kings-city-club\wp-content\themes\the-kings-city-club" /MIR /MOT:1 /NDL
